...
class TestId3v23MultipleEntries:
    def test_multiple_artists_unified_reading(self):
        with TempFileWithMetadata({"title": "Test Song"}, "mp3") as test_file:
            test_file.set_id3v2_multiple_artists(["One", "Two", "Three"], version="2.3")
    ...
    def test_comment_field_returns_first_value(self):
        with TempFileWithMetadata({"title": "Test Song"}, "mp3") as test_file:
            test_file.set_id3v2_multiple_comments(["First comment", "Second comment", "Third comment"], version="2.3")
    ...
    def test_multiple_genres(self):
        with TempFileWithMetadata({"title": "Test Song"}, "mp3") as test_file:
            test_file.set_id3v2_multiple_genres(["Rock", "Alternative", "Indie"], version="2.3")
    ...
    def test_multiple_composers(self):
        with TempFileWithMetadata({"title": "Test Song"}, "mp3") as test_file:
            test_file.set_id3v2_multiple_composers(["Composer A", "Composer B", "Composer C"], version="2.3")
