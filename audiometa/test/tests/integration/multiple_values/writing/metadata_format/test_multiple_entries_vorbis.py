...
class TestMultipleEntriesVorbis:
    def test_write_multiple_artists(self, sample_flac_file: Path, temp_audio_file: Path):
        # Write multiple artists using update_file_metadata
        metadata = {
            UnifiedMetadataKey.ARTISTS_NAMES: ["Artist One", "Artist Two", "Artist Three"]
        }
        
        update_file_metadata(temp_audio_file, metadata, metadata_format=MetadataFormat.VORBIS)
    ...
    def test_write_multiple_artists_vorbis_specific(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_multiple_album_artists(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_multiple_composers(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_multiple_involved_people(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_multiple_musicians(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_multiple_keywords(self, sample_flac_file: Path, temp_audio_file: Path):
    ...
    def test_write_mixed_single_and_multiple_values(self, sample_flac_file: Path, temp_audio_file: Path):
