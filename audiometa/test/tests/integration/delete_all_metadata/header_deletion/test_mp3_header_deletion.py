...
class TestMP3HeaderDeletion:
    ...
    def test_header_detection_comprehensive_mp3(self):        
        with TempFileWithMetadata({"title": "MP3 Test", "artist": "Test Artist"}, "mp3") as test_file:
            ...
            assert test_file.has_id3v2_header(), "has_id3v2_header should return True"
            ...
            assert not test_file.has_id3v2_header(), "has_id3v2_header should return False"
    ...
    def test_file_size_reduction_after_header_deletion(self):
        ...
        with TempFileWithMetadata({
            ...
            assert test_file.has_id3v2_header(), "ID3v2 header should exist"
            ...
            assert not test_file.has_id3v2_header(), "ID3v2 header should be removed"
