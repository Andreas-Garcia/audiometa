...
class TestArtistsDeleting:
    def test_delete_artists_id3v2(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.ARTISTS) == ["Artist 1", "Artist 2"]
    ...
    def test_delete_artists_id3v1(self):
        with TempFileWithMetadata({}, "id3v1") as test_file:
            ...
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.ARTISTS) == ["Artist 1"]
