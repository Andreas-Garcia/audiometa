...
class TestGenreDeleting:
    def test_delete_genre_id3v2(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: "Rock"}, metadata_format=MetadataFormat.ID3V2)
    ...
    def test_delete_genre_id3v1(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: "Rock"}, metadata_format=MetadataFormat.ID3V1)
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.GENRE_NAME) == ["Rock"]
    ...
    def test_delete_genre_riff(self):
        with TempFileWithMetadata({}, "wav") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: "Rock"}, metadata_format=MetadataFormat.RIFF)
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.GENRE_NAME) == ["Rock"]
    ...
    def test_delete_genre_vorbis(self):
        with TempFileWithMetadata({}, "flac") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: "Rock"}, metadata_format=MetadataFormat.VORBIS)
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.GENRE_NAME) == ["Rock"]
    ...
    def test_delete_genre_preserves_other_fields(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: None})
    ...
    def test_delete_genre_empty_string(self):
        with TempFileWithMetadata({}, "mp3") as test_file:
            ...
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: ""})
            update_file_metadata(test_file.path, {UnifiedMetadataKey.GENRE_NAME: None})
            assert get_specific_metadata(test_file.path, UnifiedMetadataKey.GENRE_NAME) is None
