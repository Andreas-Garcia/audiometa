"""Tests for binary data filtering in raw metadata output."""
...
class TestBinaryDataFiltering:
    """Test that binary data is properly filtered from raw metadata output."""

    def test_id3v2_binary_frames_filtered(self, sample_mp3_file):
        """Test that ID3v2 binary frames are filtered and replaced with size info."""
    ...
    def test_vorbis_no_binary_data(self, sample_flac_file):
        """Test that Vorbis comments don't contain binary data."""
    ...
    def test_riff_no_binary_data(self, sample_wav_file):
        """Test that RIFF metadata doesn't contain binary data."""
    ...
    def test_id3v1_no_binary_data(self, sample_mp3_file):
        """Test that ID3v1 metadata doesn't contain binary data."""
        result = get_full_metadata(sample_mp3_file)
        raw_metadata = result.get('raw_metadata', {})
